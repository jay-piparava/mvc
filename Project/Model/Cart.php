...
class Cart extends \Model\Core\Table
{
    ...
    public function getBillingAddress()
    {
        ...
        $billingAddress = \Mage::getModel('Model\Cart\Address')->load(null, $query);
    ...
    public function getShippingAddress()
    {
        ...
        $shippingAddress = \Mage::getModel('Model\Cart\Address')->load(null, $query);
    ...
    public function setShippingMethod(\Model\shiping $shipping)
    {
    ...
    public function getShippingMethod()
    {
        ...
        $shipping = \Mage::getModel('Model\shiping')->load($this->shippingMethodId);
